...
public class GatewayShaders extends RenderLayer {
    ...
    public static void register(CoreShaderRegistrationCallback.RegistrationContext ctx) throws IOException {
        ...
        ctx.register(id("gatewaycore"), VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, shader -> gatewayCoreShader = shader);
        ctx.register(id("quantumfield"), VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, shader -> quantumFieldShader = shader);
    }
    ...
    public static RenderLayer gatewayCore() {
        MultiPhaseParameters rendertype$state = MultiPhaseParameters.builder()
                ...
                .build(true);
        return of("gatewaycore", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, VertexFormat.DrawMode.QUADS, DEFAULT_BUFFER_SIZE, true, false, rendertype$state);
    }
    ...
    public static RenderLayer quantumField() {
        MultiPhaseParameters rendertype$state = MultiPhaseParameters.builder()
                ...
                .build(false);
        return of("quantumfield", VertexFormats.POSITION_COLOR_TEXTURE_OVERLAY_LIGHT_NORMAL, VertexFormat.DrawMode.QUADS, DEFAULT_BUFFER_SIZE, false, true, rendertype$state);
    }
